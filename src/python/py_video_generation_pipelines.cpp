...
void init_video_generation_pipelines(py::module_& m) {
    py::class_<ov::genai::VideoGenerationConfig>(m, "VideoGenerationConfig")
        ...
        .def_readwrite("rng_seed", &ov::genai::VideoGenerationConfig::rng_seed)
        ...
        .def("validate", &ov::genai::VideoGenerationConfig::validate)
        .def("update_generation_config", [](ov::genai::VideoGenerationConfig& config, const py::kwargs& kwargs) {
